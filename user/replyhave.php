...
<div id="nwpost">
<form action="replyhave.php" method="post" name="nwpost" class="button">
...
//Insert reply post ito DB and redirect
 ...
 $cont=$_POST['content'];
 $pid=$_POST['postid'];
 $query="insert into havecommenttable values('','".$pid."','".$uid."','".$cont."','".date('Y-m-d')."','".date('H:i:s',time())."')";
 $r=mysql_query($query);
 if($r){
	 echo "<meta http-equiv=\"REFRESH\" content=\"0;url=listhave.php?id=$pid\">";
 }
}?>
    <?php showfooter(); ?>
</body>
