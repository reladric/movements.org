...
// Rest are by default Strings
	...
	*/
	...
	function updateprofile($f,$l,$d,$dd,$a1,$a2,$c,$s,$co,$z,$p,$se,$nn,$tw,$fbk,$lnd){
		$this->fname=$f;
		$this->lname=$l;
		$this->dob=$d;
		$this->dispdob=$dd;
		...
		$this->fb=$fbk;
		$this->ln=$lnd;
		$sql="update user set firstname='".$f."',lastname='".$l."',dob='".$d."',disp_dob='".$dd."',addr1='".$a1."',addr2='".$a2."',city='".$c."',state='".$s."',country='".$co."',zip='".$z."',phone='".$p."',sec_email='".$se."',nickname='".$nn."',twitter='".$tw."',fb='".$fbk."',linkedin='".$lnd."',iscomplete='1' where uid=".$this->getUid();
